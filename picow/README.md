...
- Has a switch in BIOS to activate WOL
...
### 2026-02-19 Automatic Suspend

After upgrading my server to a Penta-GPU machine (should I rename it to penta?) I also implemented the automatic sleep script when Ollama is idle. And a keystroke can wake it up - here simulated with a Raspberry Pico W over Wifi, running Circuitpython 10.1.1
...
A later iteration will have a small web interface that shows what you entered.
